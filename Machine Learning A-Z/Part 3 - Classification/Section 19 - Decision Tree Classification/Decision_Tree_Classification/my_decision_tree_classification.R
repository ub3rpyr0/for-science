...
y_pred=predict(classifier,newdata=test_set[-3], type='class') # change to a vector instead of matrix
...
y_grid = predict(classifier, newdata=grid_set, type='class') # changed as above y_pred
plot(set[, -3],
