...
"""
Predict if a customer with the following information will leave the bank:
    Geography: France
    Credit Score: 600
    Gender: Male
    Age: 40
...
new_prediction_bool = (new_prediction >= 0.5)
...
# See the classifier creation code under Initializing the ANN
